<?php
    class travelPost
    {
        ...
        public function getlistTraleviewing(){
            ...
            $num_page = ($page-1)*$num;
            $sql = "SELECT * FROM travelviewing order by id LIMIT $num_page,$num";
        ...
        public function getalllistTraleviewing(){
            $sql = "SELECT * FROM travelviewing order by id ";
            $data = mysqli_query($this->conect, $sql);
            $count = mysqli_num_rows($data);
            if($count == 0) {
                $this->getconect->dieconnect($this->conect); return array();
        ...
        public function getallTraleviewing(){
