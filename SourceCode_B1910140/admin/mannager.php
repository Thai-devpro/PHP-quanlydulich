<div class="Container">
    <div class="box-menu">
        <div class="administrator-logo">
            <img style="width: 27px;  float: left; height: 100%;" src="../upload/accout.png">
    ...
    <div class="main-screen" >
        <div class="screen-menu" style="background: #0098a1;">
            <div style="margin-right: 10px;float: right; "><a  class="link-home" href="../" style="color:#fff" ><i style="padding-right: 5px;" class="fas fa-home">
        ...
        <div class="screen-slides">
            ...
            if(isset($_GET['select'])){
               ...
               // if($sl === 'newposts') include "./control/newposts-hide.php";
                ...
                echo "<div style='color: #0098a1; width: 100%; height: 100%;'>
